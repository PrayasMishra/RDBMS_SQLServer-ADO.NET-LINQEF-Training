...
---3----
exec sp_bindefault Region_default,'Customer.Customer_Region'
---4---
alter table Customer add Customer_Region Region
---5---
alter table Customer add Gender char(1)
---6---
alter table Customer add constraint chk_gender check(Gender in('M','F','T'))
---7---8---9---
create table Orders(OrdersId int not null identity(1000,1) constraint fk_CustOrders foreign key references Customer(Customerid),
